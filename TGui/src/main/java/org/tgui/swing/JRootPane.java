...
import org.tgui.awt.BorderLayout;
import org.tgui.awt.Container;
import org.tgui.awt.IllegalComponentStateException;
import org.tgui.awt.NoLayout;
...
public class JRootPane extends JComponent {
	...
	public void setGlassPane(Container glassPane) {
		...
		glassPane.getHTMLElement().getStyle().setProperty("zIndex", "1");
